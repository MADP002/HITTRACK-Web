      ...
      <div style={{position:'relative',overflow:'hidden',borderRadius:14,background:'rgba(74,222,128,0.12)',border:'1.5px solid rgba(74,222,128,0.5)',boxShadow:'0 4px 16px rgba(0,0,0,0.3)',flexShrink:0,width:'100%',boxSizing:'border-box'}}>
        ...
        <div style={{padding:'16px 20px 16px 24px',display:'flex',alignItems:'center',gap:14}}>
          ...
          <div style={{flex:1,minWidth:0}}>
            <div style={{fontSize:13,fontWeight:800,color:'#4ade80',marginBottom:5,letterSpacing:'0.02em',lineHeight:1.3}}>Medical Clearance · No injury declared</div>
            <div style={{fontSize:12,color:'#f0ece8',lineHeight:1.6}}>This member is cleared to train — no medical certificate required.</div>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div style={{position:'relative',overflow:'hidden',borderRadius:14,background:'rgba(245,200,66,0.14)',border:'1.5px solid rgba(245,200,66,0.55)',boxShadow:'0 4px 16px rgba(0,0,0,0.3)',flexShrink:0,width:'100%',boxSizing:'border-box'}}>
        ...
        <div style={{padding:'16px 20px 16px 24px',display:'flex',alignItems:'center',gap:14}}>
          ...
          <div style={{flex:1,minWidth:0}}>
            <div style={{fontSize:13,fontWeight:800,color:'#f5c842',letterSpacing:'0.04em',marginBottom:5}}>Awaiting medical certificate</div>
            <div style={{fontSize:12,color:'#f0ece8',lineHeight:1.6}}>
        ...
        <div style={{padding:'16px 20px 16px 24px',display:'flex',alignItems:'center',gap:14,flexWrap:'wrap'}}>
          ...
          <div style={{flex:1,minWidth:0}}>
            <div style={{display:'flex',alignItems:'center',gap:6,flexWrap:'wrap',marginBottom:4}}>
              <span style={{fontSize:13,fontWeight:800,color:'#4ade80',letterSpacing:'0.04em'}}>Medical Certificate</span>
      ...
      {viewing && (
        <div onClick={()=>setViewing(false)}
          ...
          <div onClick={e=>e.stopPropagation()}
            style={{position:'relative',background:'linear-gradient(135deg,#1a1413 0%,#0e0a0a 100%)',borderRadius:18,border:'1px solid rgba(74,222,128,0.4)',maxWidth:720,width:'100%',maxHeight:'90vh',display:'flex',flexDirection:'column',overflow:'hidden',boxShadow:'0 24px 60px rgba(0,0,0,0.8)'}}>
            <div style={{position:'absolute',left:0,top:0,bottom:0,width:5,background:'linear-gradient(180deg,#4ade80,#22c55e)'}}/>
            ...
            <div style={{padding:'16px 22px',borderBottom:'1px solid rgba(74,222,128,0.18)',background:'linear-gradient(135deg,rgba(74,222,128,0.08) 0%,transparent 60%)',display:'flex',alignItems:'center',gap:12,flexShrink:0}}>
              ...
              <div style={{flex:1,minWidth:0}}>
                <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:18,letterSpacing:'0.06em',color:'#f0ece8'}}>MEDICAL CERTIFICATE</div>
            ...
            {/* Body — scrollable */}
            <div style={{flex:1,minHeight:0,overflowY:'auto',padding:'20px',background:'#0e0a0a'}}>
              {isImage ? (
                <img src={cert.base64} alt="Medical certificate"
                  style={{display:'block',maxWidth:'100%',maxHeight:'72vh',margin:'0 auto',borderRadius:10,border:'1px solid rgba(255,255,255,0.08)',background:'#fff'}}/>
              ) : isPdf ? (
                <div style={{textAlign:'center',padding:'40px 20px',display:'flex',flexDirection:'column',alignItems:'center',gap:14}}>
                  <div style={{fontSize:56}}>📄</div>
                  <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:20,letterSpacing:'0.04em',color:'#f0ece8'}}>PDF CERTIFICATE</div>
                  <div style={{fontSize:12,color:'#888',maxWidth:380,lineHeight:1.6}}>
                ...
                <div style={{textAlign:'center',padding:'40px 20px',color:'#888',fontSize:12}}>
                  ...
                  <div style={{marginTop:14}}>
                    <a href={cert.base64} download={cert.fileName || 'certificate'}
                      style={{color:'#42a5f5',textDecoration:'underline',fontSize:12}}>
